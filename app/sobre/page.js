...
export default function Sobre() {
  return (
    <div>
      ...
      <p>Não obstante o trabalho fundamental e meritório da Assembleia da República, acreditamos que sociedade civil deve também desempenhar um papel no escrutínio da ação governativa. Por essa razão nasce “O Joca Já Cumpriu”, cujo objetivo é acompanhar de forma simples e sistemática o cumprimento do programa do Governo.</p>
