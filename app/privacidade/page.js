...
export default function Sobre() {
  return (
    <div>
      ...
      <p className="py-1">Se desejar entrar em contacto conosco para entender mais sobre esta Política ou se quiser falar sobre qualquer assunto relacionado aos direitos individuais e as suas informações pessoais, pode enviar um email para geral@ojocajacumpriu.vercel.com.</p>
    </div>
  )
}
